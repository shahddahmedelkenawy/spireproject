    ...
    <main class="auth-main">
      <div class="auth-inner">
        <div class="auth-brand">
          ...
          <h1 class="auth-headline">Welcome to Spire</h1>
        ...
        <p class="auth-footer-text">
          ...
          <router-link :to="{ path: '/login', query: { role } }" class="auth-link-inline">
            Login
          </router-link>
        </p>
      </div>
...
const role = computed(() => route.query.role || 'seeker')
...
async function onSubmit() {
  ...
  try {
    ...
    router.push('/job-seeker/register')
  } catch (error) {
