...
/** Hide floating FAB on Spira chat — no duplicate fixed a11y control over the composer. */
const showTrigger = computed(() => route.path !== '/' && !isSpiraChatRoute())
...
.a11y-float-btn {
  ...
  color: #fff;
  cursor: grab;
  box-shadow: 0 6px 20px rgba(75, 30, 90, 0.45);
  touch-action: none;
}
