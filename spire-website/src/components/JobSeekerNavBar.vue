  ...
  <q-header class="jsk-nav" elevated>
    <div class="jsk-nav__inner">
      ...
      <div v-if="!compact" class="jsk-nav__row jsk-nav__row--desktop">
        <div class="jsk-nav__segment jsk-nav__segment--left">
          ...
          <div class="jsk-nav__search-wrap">
            ...
            >
              <template #prepend>
                <q-icon name="search" size="22px" class="jsk-nav__search-ic" />
              </template>
        ...
        <div class="jsk-nav__segment jsk-nav__segment--right">
          <router-link to="/profile" class="jsk-nav__profile-link">
            <q-avatar size="40px" class="jsk-nav__avatar">
      ...
      <div v-else class="jsk-nav__row jsk-nav__row--mobile-top">
        ...
        <div class="jsk-nav__segment jsk-nav__segment--right">
          <router-link to="/profile" class="jsk-nav__profile-link">
            <q-avatar size="38px" class="jsk-nav__avatar">
              <img v-if="photoUrl" :src="photoUrl" alt="">
              <span v-else>{{ userInitial }}</span>
            </q-avatar>
...
.jsk-nav {
  ...
  min-height: var(--jsk-nav-height, 94px);
}
...
.jsk-nav__row--desktop {
  display: grid;
  /* Give the logo + search column most horizontal space so the search can grow wide */
...
.jsk-nav__row--mobile-top {
  ...
  min-height: calc(var(--jsk-nav-height, 94px) - 12px);
  gap: 10px;
}
...
.jsk-nav__search-wrap {
  /* Flex-grow into all remaining space in the left segment (width max removed — it was capping the bar) */
  flex: 1 1 0%;
  width: 0;
  min-width: 160px;
  max-width: none;
...
.jsk-nav__search :deep(.q-field__control) {
  ...
  /* Slimmer vertical profile while staying pill-shaped */
  min-height: 46px;
  height: 46px;
...
.jsk-nav__search :deep(.q-field__outline) {
  border-radius: 9999px !important;
  color: rgba(61, 11, 82, 0.14);
}

.jsk-nav__search :deep(.q-field__marginal) {
  height: 46px;
}
