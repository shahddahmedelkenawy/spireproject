<template>
  <div class="auth-inner">
    ...
    <p class="auth-footer-text">
      ...
      <button v-if="dialogMode" type="button" class="auth-link-inline auth-link-btn" @click="$emit('switch-signup')">
        Sign Up
      </button>
      <router-link v-else :to="{ path: '/signup', query: footerSignupQuery }" class="auth-link-inline">
        Sign Up
      </router-link>
    </p>
  </div>
...
const emit = defineEmits(['switch-signup', 'done'])
...
const footerSignupQuery = computed(() => {
